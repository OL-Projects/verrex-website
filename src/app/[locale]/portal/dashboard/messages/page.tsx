...
export default function MessagesPage() {
  ...
  // Proper download-to-desktop handler (fetch → blob → save)
              ...
              <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 dark:border-white/5 shrink-0">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <button onClick={() => handleDownload(previewFile.url, previewFile.name)}
                    className="p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-white/10 text-slate-400 hover:text-slate-600 transition-colors" title="Save to Desktop">
