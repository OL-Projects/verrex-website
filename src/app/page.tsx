  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden min-h-[600px]">
        ...
        <div className="absolute inset-0 z-[1] bg-gradient-to-l from-slate-950/55 via-slate-900/15 to-transparent dark:from-slate-950/60 dark:via-slate-950/20 dark:to-transparent" />
