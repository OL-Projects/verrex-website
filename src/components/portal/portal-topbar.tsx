...
export function PortalTopbar({ onMenuClick }: PortalTopbarProps) {
  ...
  return (
    <div className="h-16 border-b border-slate-200 dark:border-[rgba(255,255,255,0.07)] bg-white/60 dark:bg-[rgba(12,13,18,0.75)] backdrop-blur-xl flex items-center justify-between px-4 sm:px-6 relative z-[100]">
